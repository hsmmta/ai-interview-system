        ...
        <div class="form-group">
          ...
          <div class="radio-group">
            <label class="radio-label">
              <input type="radio" v-model="intent" value="ai算法工程师" required />
              <span>AI 算法工程师</span>
            </label>
            <label class="radio-label">
              <input type="radio" v-model="intent" value="ai数据开发工程师" required />
              <span>AI 数据开发工程师</span>
            </label>
          </div>
        </div>
...
const sendCode = async () => {
  ...
  try {
    ...
    await axios.post('/api/register', { action: 'sendCode', phone: phone.value })
