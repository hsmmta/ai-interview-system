...
public class DBUtil {
    ...
    private static void initDB() {
        try (Connection conn = getConnection();
            ...
            try { stmt.execute("ALTER TABLE users ADD COLUMN resume_path TEXT"); } catch (Exception e) {/* ignore if exists */}
            try { stmt.execute("ALTER TABLE users ADD COLUMN password TEXT"); } catch (Exception e) {/* ignore if exists */}
